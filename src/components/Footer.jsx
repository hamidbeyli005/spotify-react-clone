...
import { FaTwitter, FaFacebookF, FaGlobeAmericas } from "react-icons/fa";
      ...
      <section>
        <div className="top">
          ...
          <ul>
            <li>ŞİRKƏT</li>
            <li>
              <a href="https://www.spotify.com/az-az/about-us/contact/">
                Haqqında
              </a>
            </li>
            <li>
        ...
        <div className="bottom">
          <div className="country">
            <a href="https://www.spotify.com/az-az/select-your-country-region/">
              <FaGlobeAmericas></FaGlobeAmericas>
              Azərbaycan (Azərbaycanca)
            </a>
          </div>
          <nav>
            <ul>
              <li>
                <a href="https://www.spotify.com/az-az/legal/">Hüquqi</a>
              </li>
              <li>
                <a href="https://www.spotify.com/az-az/privacy/">
                  Məxfilik Mərkəzi
                </a>
              </li>
              <li>
                <a href="https://www.spotify.com/az-az/legal/privacy-policy/">
                  Məxfilik Siyasəti
                </a>
              </li>
              <li>
                <a href="https://www.spotify.com/az-az/legal/cookies-policy/">
                  Kukilər
                </a>
              </li>
              <li>
                <a href="https://www.spotify.com/az-az/legal/privacy-policy/#s3">
                  Reklamlar haqqında
                </a>
              </li>
            </ul>
